...
coordinates = ElementCoordinates(p=0, q=0.005657, angle_radial=0.7853354735, angle_azimuthal=-numpy.pi/4, angle_radial_out=0.7853354735)
movements = None
...
print("Intensity at source: ",   BEAMS[0].get_column(24)[0], BEAMS[0].get_column(25)[0], "analytical", 1,0,)
print("Intensity after xtal1: ", BEAMS[1].get_column(24)[0], BEAMS[1].get_column(25)[0], "analytical", numpy.abs(0.5 * r_s_ampl**1           )**2   , numpy.abs(0.5 * r_s_ampl    * r_p_ampl**0)**2)
